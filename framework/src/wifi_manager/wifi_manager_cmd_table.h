...
WIFIMGR_REQUEST_TABLE("CMD_DISABLE_BFMEE_MODE", WIFIMGR_CMD_DISABLE_BFMEE_MODE, "Command to disable/enable beamformee mode")
WIFIMGR_REQUEST_TABLE("CMD_DISABLE_OFDMA_MODE", WIFIMGR_CMD_DISABLE_OFDMA_MODE, "Command to disable/enable OFDMA mode")
